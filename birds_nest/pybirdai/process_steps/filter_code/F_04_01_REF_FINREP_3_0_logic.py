...
class F_04_01_REF_FINREP_3_0_UnionItem:
	base = None #F_04_01_REF_FINREP_3_0_Base
...
class F_04_01_REF_FINREP_3_0_UnionTable :
	F_04_01_REF_FINREP_3_0_UnionItems = [] # F_04_01_REF_FINREP_3_0_UnionItem []
	F_04_01_REF_FINREP_3_0_Derivatives_ETC_Table = None # Derivatives_ETC
	F_04_01_REF_FINREP_3_0_Derivatives_OTC_Table = None # Derivatives_OTC
	F_04_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_04_01_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	F_04_01_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	def calc_F_04_01_REF_FINREP_3_0_UnionItems(self) -> list[F_04_01_REF_FINREP_3_0_UnionItem] :
		items = [] # F_04_01_REF_FINREP_3_0_UnionItem []
		for item in self.F_04_01_REF_FINREP_3_0_Derivatives_ETC_Table.Derivatives_ETCs:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Derivatives_OTC_Table.Derivatives_OTCs:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
	...
	def init(self):
		...
		self.F_04_01_REF_FINREP_3_0_UnionItems = []
		self.F_04_01_REF_FINREP_3_0_UnionItems.extend(self.calc_F_04_01_REF_FINREP_3_0_UnionItems())
...
class Derivatives_OTC(F_04_01_REF_FINREP_3_0_Base):
...
class Non_Negotiable_bonds(F_04_01_REF_FINREP_3_0_Base):
...
class Loans_and_advances(F_04_01_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_ORGN"})
	def TYP_INSTRMNT(self):
		return self.INSTRMNT.INSTRMNT_TYP_ORGN
...
class F_04_01_REF_FINREP_3_0_Derivatives_OTC_Table:
...
class F_04_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table:
...
class F_04_01_REF_FINREP_3_0_Loans_and_advances_Table:
	INSTRMNT_Table = None # INSTRMNT
	PRTY_Table = None # PRTY
