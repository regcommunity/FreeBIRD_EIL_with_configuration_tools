...
class F_18_00_b_REF_FINREP_3_0_UnionTable :
	...
	F_18_00_b_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	F_18_00_b_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_18_00_b_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	F_18_00_b_REF_FINREP_3_0_Off_balance_sheet_exposures_subject_to_credit_risk_Table = None # Off_balance_sheet_exposures_subject_to_credit_risk
	...
	def calc_F_18_00_b_REF_FINREP_3_0_UnionItems(self) -> list[F_18_00_b_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_18_00_b_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
		...
		for item in self.F_18_00_b_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_b_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_18_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_b_REF_FINREP_3_0_Off_balance_sheet_exposures_subject_to_credit_risk_Table.Off_balance_sheet_exposures_subject_to_credit_risks:
			newItem = F_18_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
...
class Debt_securities(F_18_00_b_REF_FINREP_3_0_Base):
...
class Loans_and_advances(F_18_00_b_REF_FINREP_3_0_Base):
...
class Off_balance_sheet_exposures_subject_to_credit_risk(F_18_00_b_REF_FINREP_3_0_Base):
...
class F_18_00_b_REF_FINREP_3_0_Debt_securities_Table:
...
class F_18_00_b_REF_FINREP_3_0_Loans_and_advances_Table:
...
class F_18_00_b_REF_FINREP_3_0_Off_balance_sheet_exposures_subject_to_credit_risk_Table:
