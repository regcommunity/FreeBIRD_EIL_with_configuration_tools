...
class F_04_10_REF_FINREP_3_0_UnionTable :
	...
	F_04_10_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	F_04_10_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_04_10_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	def calc_F_04_10_REF_FINREP_3_0_UnionItems(self) -> list[F_04_10_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_04_10_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
		...
		for item in self.F_04_10_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_10_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_04_10_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Debt_securities(F_04_10_REF_FINREP_3_0_Base):
...
class Loans_and_advances(F_04_10_REF_FINREP_3_0_Base):
...
class F_04_10_REF_FINREP_3_0_Debt_securities_Table:
...
class F_04_10_REF_FINREP_3_0_Loans_and_advances_Table:
