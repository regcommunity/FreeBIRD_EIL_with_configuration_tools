...
class F_01_02_REF_FINREP_3_0_UnionTable :
	...
	F_01_02_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	F_01_02_REF_FINREP_3_0_Derivatives_ETC_Table = None # Derivatives_ETC
	F_01_02_REF_FINREP_3_0_Derivatives_OTC_Table = None # Derivatives_OTC
	def calc_F_01_02_REF_FINREP_3_0_UnionItems(self) -> list[F_01_02_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_01_02_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_01_02_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_01_02_REF_FINREP_3_0_Derivatives_ETC_Table.Derivatives_ETCs:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_01_02_REF_FINREP_3_0_Derivatives_OTC_Table.Derivatives_OTCs:
			newItem = F_01_02_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Debt_securities(F_01_02_REF_FINREP_3_0_Base):
...
class Derivatives_OTC(F_01_02_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_ORGN"})
	def TYP_INSTRMNT(self):
		return self.INSTRMNT.INSTRMNT_TYP_ORGN
...
class F_01_02_REF_FINREP_3_0_Debt_securities_Table:
...
class F_01_02_REF_FINREP_3_0_Derivatives_OTC_Table:
	INSTRMNT_Table = None # INSTRMNT
