...
class F_09_01_1_REF_FINREP_3_0_UnionItem:
	base = None #F_09_01_1_REF_FINREP_3_0_Base
...
class F_09_01_1_REF_FINREP_3_0_Base:
	def CRRYNG_AMNT() -> int:
		pass
...
class F_09_01_1_REF_FINREP_3_0_UnionTable :
	F_09_01_1_REF_FINREP_3_0_UnionItems = [] # F_09_01_1_REF_FINREP_3_0_UnionItem []
	F_09_01_1_REF_FINREP_3_0_Financial_guarantees_given_Table = None # Financial_guarantees_given
	def calc_F_09_01_1_REF_FINREP_3_0_UnionItems(self) -> list[F_09_01_1_REF_FINREP_3_0_UnionItem] :
		items = [] # F_09_01_1_REF_FINREP_3_0_UnionItem []
		for item in self.F_09_01_1_REF_FINREP_3_0_Financial_guarantees_given_Table.Financial_guarantees_givens:
			newItem = F_09_01_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
	...
	def init(self):
		...
		self.F_09_01_1_REF_FINREP_3_0_UnionItems = []
		self.F_09_01_1_REF_FINREP_3_0_UnionItems.extend(self.calc_F_09_01_1_REF_FINREP_3_0_UnionItems())
...
class F_09_01_1_REF_FINREP_3_0_Financial_guarantees_given_Table:
