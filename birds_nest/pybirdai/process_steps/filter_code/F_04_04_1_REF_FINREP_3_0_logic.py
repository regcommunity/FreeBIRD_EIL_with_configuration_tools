...
class F_04_04_1_REF_FINREP_3_0_UnionItem:
	base = None #F_04_04_1_REF_FINREP_3_0_Base
...
class F_04_04_1_REF_FINREP_3_0_Base:
...
class F_04_04_1_REF_FINREP_3_0_UnionTable :
	F_04_04_1_REF_FINREP_3_0_UnionItems = [] # F_04_04_1_REF_FINREP_3_0_UnionItem []
	F_04_04_1_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	F_04_04_1_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_04_04_1_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	def calc_F_04_04_1_REF_FINREP_3_0_UnionItems(self) -> list[F_04_04_1_REF_FINREP_3_0_UnionItem] :
		items = [] # F_04_04_1_REF_FINREP_3_0_UnionItem []
		for item in self.F_04_04_1_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_04_04_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_04_1_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_04_04_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_04_1_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_04_04_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
	...
	def init(self):
		...
		self.F_04_04_1_REF_FINREP_3_0_UnionItems = []
		self.F_04_04_1_REF_FINREP_3_0_UnionItems.extend(self.calc_F_04_04_1_REF_FINREP_3_0_UnionItems())
		CSVConverter.persist_object_as_csv(self,True)
		return None


class Debt_securities(F_04_04_1_REF_FINREP_3_0_Base):
...
class Non_Negotiable_bonds(F_04_04_1_REF_FINREP_3_0_Base):
	LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT = None # LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT
	@lineage(dependencies={"LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT.ACCMLTD_PRTL_WRTFFS"})
	def ACCMLTD_PRTL_WRTFFS(self):
		return self.LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT.ACCMLTD_PRTL_WRTFFS
...
class Loans_and_advances(F_04_04_1_REF_FINREP_3_0_Base):
...
class F_04_04_1_REF_FINREP_3_0_Debt_securities_Table:
...
class F_04_04_1_REF_FINREP_3_0_Non_Negotiable_bonds_Table:
	LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT_Table = None # LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT
	PRTY_Table = None # PRTY
...
class F_04_04_1_REF_FINREP_3_0_Loans_and_advances_Table:
