...
class F_19_00_b_REF_FINREP_3_0_UnionItem:
	base = None #F_19_00_b_REF_FINREP_3_0_Base
...
class F_19_00_b_REF_FINREP_3_0_Base:
...
class F_19_00_b_REF_FINREP_3_0_UnionTable :
	F_19_00_b_REF_FINREP_3_0_UnionItems = [] # F_19_00_b_REF_FINREP_3_0_UnionItem []
	F_19_00_b_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_19_00_b_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	F_19_00_b_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	def calc_F_19_00_b_REF_FINREP_3_0_UnionItems(self) -> list[F_19_00_b_REF_FINREP_3_0_UnionItem] :
		items = [] # F_19_00_b_REF_FINREP_3_0_UnionItem []
		for item in self.F_19_00_b_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_19_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_19_00_b_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_19_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_19_00_b_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_19_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
	...
	def init(self):
		...
		self.F_19_00_b_REF_FINREP_3_0_UnionItems = []
		self.F_19_00_b_REF_FINREP_3_0_UnionItems.extend(self.calc_F_19_00_b_REF_FINREP_3_0_UnionItems())
		CSVConverter.persist_object_as_csv(self,True)
		return None


class Non_Negotiable_bonds(F_19_00_b_REF_FINREP_3_0_Base):
...
class Loans_and_advances(F_19_00_b_REF_FINREP_3_0_Base):
...
class Debt_securities(F_19_00_b_REF_FINREP_3_0_Base):
	LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT = None # LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT
	@lineage(dependencies={"LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT.ACCNTNG_CLSSFCTN"})
	def ACCNTNG_CLSSFCTN(self):
		return self.LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT.ACCNTNG_CLSSFCTN
...
class F_19_00_b_REF_FINREP_3_0_Non_Negotiable_bonds_Table:
...
class F_19_00_b_REF_FINREP_3_0_Loans_and_advances_Table:
...
class F_19_00_b_REF_FINREP_3_0_Debt_securities_Table:
	LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT_Table = None # LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT
	PRTY_Table = None # PRTY
