...
class F_18_00_c_REF_FINREP_3_0_UnionItem:
	base = None #F_18_00_c_REF_FINREP_3_0_Base
...
class F_18_00_c_REF_FINREP_3_0_Base:
...
class F_18_00_c_REF_FINREP_3_0_UnionTable :
	F_18_00_c_REF_FINREP_3_0_UnionItems = [] # F_18_00_c_REF_FINREP_3_0_UnionItem []
	F_18_00_c_REF_FINREP_3_0_Financial_guarantees_given_Table = None # Financial_guarantees_given
	F_18_00_c_REF_FINREP_3_0_Off_balance_sheet_exposures_subject_to_credit_risk_Table = None # Off_balance_sheet_exposures_subject_to_credit_risk
	F_18_00_c_REF_FINREP_3_0_Debt_securities_Table = None # Debt_securities
	F_18_00_c_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_18_00_c_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	def calc_F_18_00_c_REF_FINREP_3_0_UnionItems(self) -> list[F_18_00_c_REF_FINREP_3_0_UnionItem] :
		items = [] # F_18_00_c_REF_FINREP_3_0_UnionItem []
		for item in self.F_18_00_c_REF_FINREP_3_0_Financial_guarantees_given_Table.Financial_guarantees_givens:
			newItem = F_18_00_c_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_c_REF_FINREP_3_0_Off_balance_sheet_exposures_subject_to_credit_risk_Table.Off_balance_sheet_exposures_subject_to_credit_risks:
			newItem = F_18_00_c_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_c_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_18_00_c_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_c_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_18_00_c_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_c_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_18_00_c_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
	...
	def init(self):
		...
		self.F_18_00_c_REF_FINREP_3_0_UnionItems = []
		self.F_18_00_c_REF_FINREP_3_0_UnionItems.extend(self.calc_F_18_00_c_REF_FINREP_3_0_UnionItems())
		CSVConverter.persist_object_as_csv(self,True)
		return None


class Financial_guarantees_given(F_18_00_c_REF_FINREP_3_0_Base):
...
class Off_balance_sheet_exposures_subject_to_credit_risk(F_18_00_c_REF_FINREP_3_0_Base):
...
class Debt_securities(F_18_00_c_REF_FINREP_3_0_Base):
...
class Non_Negotiable_bonds(F_18_00_c_REF_FINREP_3_0_Base):
	LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT = None # LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT
	@lineage(dependencies={"LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT.ACCNTNG_CLSSFCTN"})
	def ACCNTNG_CLSSFCTN(self):
		return self.LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT.ACCNTNG_CLSSFCTN
...
class Loans_and_advances(F_18_00_c_REF_FINREP_3_0_Base):
...
class F_18_00_c_REF_FINREP_3_0_Financial_guarantees_given_Table:
...
class F_18_00_c_REF_FINREP_3_0_Off_balance_sheet_exposures_subject_to_credit_risk_Table:
...
class F_18_00_c_REF_FINREP_3_0_Debt_securities_Table:
...
class F_18_00_c_REF_FINREP_3_0_Non_Negotiable_bonds_Table:
	LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT_Table = None # LNG_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMNT_ACCNTNG_CLSSFCTN_FNNCL_ASSTS_ASSGNMNT
	PRTY_Table = None # PRTY
...
class F_18_00_c_REF_FINREP_3_0_Loans_and_advances_Table:
