...
class F_06_01_REF_FINREP_3_0_UnionTable :
	...
	F_06_01_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	def calc_F_06_01_REF_FINREP_3_0_UnionItems(self) -> list[F_06_01_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_06_01_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_06_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_06_01_REF_FINREP_3_0_Base):
...
class F_06_01_REF_FINREP_3_0_Loans_and_advances_Table:
