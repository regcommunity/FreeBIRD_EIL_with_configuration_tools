...
class F_13_01_REF_FINREP_3_0_UnionItem:
	base = None #F_13_01_REF_FINREP_3_0_Base
...
class F_13_01_REF_FINREP_3_0_Base:
...
class F_13_01_REF_FINREP_3_0_UnionTable :
	F_13_01_REF_FINREP_3_0_UnionItems = [] # F_13_01_REF_FINREP_3_0_UnionItem []
	F_13_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table = None # Non_Negotiable_bonds
	F_13_01_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	def calc_F_13_01_REF_FINREP_3_0_UnionItems(self) -> list[F_13_01_REF_FINREP_3_0_UnionItem] :
		items = [] # F_13_01_REF_FINREP_3_0_UnionItem []
		for item in self.F_13_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_13_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_13_01_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_13_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
	...
	def init(self):
		...
		self.F_13_01_REF_FINREP_3_0_UnionItems = []
		self.F_13_01_REF_FINREP_3_0_UnionItems.extend(self.calc_F_13_01_REF_FINREP_3_0_UnionItems())
		CSVConverter.persist_object_as_csv(self,True)
		return None


class Non_Negotiable_bonds(F_13_01_REF_FINREP_3_0_Base):
...
class Loans_and_advances(F_13_01_REF_FINREP_3_0_Base):
...
class F_13_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table:
...
class F_13_01_REF_FINREP_3_0_Loans_and_advances_Table:
