...
class F_20_06_REF_FINREP_3_0_UnionTable :
	...
	F_20_06_REF_FINREP_3_0_Derivatives_OTC_Table = None # Derivatives_OTC
	...
	def calc_F_20_06_REF_FINREP_3_0_UnionItems(self) -> list[F_20_06_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_20_06_REF_FINREP_3_0_Derivatives_OTC_Table.Derivatives_OTCs:
			newItem = F_20_06_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
...
class Derivatives_OTC(F_20_06_REF_FINREP_3_0_Base):
...
class F_20_06_REF_FINREP_3_0_Derivatives_OTC_Table:
