...
class F_11_01_REF_FINREP_3_0_UnionItem:
	base = None #F_11_01_REF_FINREP_3_0_Base
...
class F_11_01_REF_FINREP_3_0_Base:
	def NTNL_AMNT() -> int:
		pass
...
class F_11_01_REF_FINREP_3_0_UnionTable :
	F_11_01_REF_FINREP_3_0_UnionItems = [] # F_11_01_REF_FINREP_3_0_UnionItem []
	F_11_01_REF_FINREP_3_0_Derivatives_ETC_Table = None # Derivatives_ETC
	F_11_01_REF_FINREP_3_0_Derivatives_OTC_Table = None # Derivatives_OTC
	def calc_F_11_01_REF_FINREP_3_0_UnionItems(self) -> list[F_11_01_REF_FINREP_3_0_UnionItem] :
		items = [] # F_11_01_REF_FINREP_3_0_UnionItem []
		for item in self.F_11_01_REF_FINREP_3_0_Derivatives_ETC_Table.Derivatives_ETCs:
			newItem = F_11_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_11_01_REF_FINREP_3_0_Derivatives_OTC_Table.Derivatives_OTCs:
			newItem = F_11_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
	...
	def init(self):
		...
		self.F_11_01_REF_FINREP_3_0_UnionItems = []
		self.F_11_01_REF_FINREP_3_0_UnionItems.extend(self.calc_F_11_01_REF_FINREP_3_0_UnionItems())
		CSVConverter.persist_object_as_csv(self,True)
		return None


class Derivatives_ETC(F_11_01_REF_FINREP_3_0_Base):
	pass

class Derivatives_OTC(F_11_01_REF_FINREP_3_0_Base):
...
class F_11_01_REF_FINREP_3_0_Derivatives_ETC_Table:
...
class F_11_01_REF_FINREP_3_0_Derivatives_OTC_Table:
