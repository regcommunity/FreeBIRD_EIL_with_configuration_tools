...
class F_41_01_REF_FINREP_3_0_UnionTable :
	...
	F_41_01_REF_FINREP_3_0_Loans_and_advances_Table = None # Loans_and_advances
	def calc_F_41_01_REF_FINREP_3_0_UnionItems(self) -> list[F_41_01_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_41_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_41_01_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_41_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_41_01_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_ORGN"})
	def TYP_INSTRMNT(self):
		return self.INSTRMNT.INSTRMNT_TYP_ORGN
...
class F_41_01_REF_FINREP_3_0_Loans_and_advances_Table:
	INSTRMNT_Table = None # INSTRMNT
