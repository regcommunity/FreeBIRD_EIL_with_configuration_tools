...
class ColumnIndexes(object):
    ...
    sdd_cube_structure_item_cube_structure_item_id = 0
    sdd_cube_structure_item_cube_structure_id = 1
    sdd_cube_structure_item_cube_variable_code = 2
    sdd_cube_structure_item_variable_id = 3
    sdd_cube_structure_item_role = 4
    sdd_cube_structure_item_order = 5
    sdd_cube_structure_item_subdomain_id = 6
    sdd_cube_structure_item_variable_set_id = 7
    sdd_cube_structure_item_member_id = 8
    sdd_cube_structure_item_dimension_type = 9
    sdd_cube_structure_item_attribute_associated_variable = 10
    sdd_cube_structure_item_is_flow = 11
    sdd_cube_structure_item_is_mandatory = 12
    sdd_cube_structure_item_description = 13
    sdd_cube_structure_item_is_implemented = 14

    sdd_subdomain_maintenance_agency_id_id = 0
    sdd_subdomain_subdomain_id = 1
    sdd_subdomain_name = 2
    sdd_subdomain_domain_id_id = 3
    sdd_subdomain_is_listed = 4
    sdd_subdomain_code = 5
    sdd_subdomain_facet_id_id = 6
    sdd_subdomain_description = 7
    sdd_subdomain_is_natural = 8

    sdd_subdomain_enumeration_member_id_id = 0
    sdd_subdomain_enumeration_subdomain_id_id = 1
    sdd_subdomain_enumeration_valid_from = 2
    sdd_subdomain_enumeration_valid_to = 3
    sdd_subdomain_enumeration_order = 4
